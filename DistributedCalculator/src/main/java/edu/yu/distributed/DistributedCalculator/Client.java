...
public class Client implements Watcher, Closeable {
    ...
    StringCallback createTaskCallback = new StringCallback() {
        public void processResult(int rc, String path, Object ctx, String name) {
            ...
            case OK:
                ...
                watchStatus(name.replace("/tasks/", "/status/"), ctx); ///HERE YOU CAN CHANGE WHERE THE CLIENT WATCHES
    ...
    public static void main(String args[]) throws Exception { 
        ...
        Thread.sleep(100);
        c.submitTask("calculate + five two three five six three five two six", task6);
